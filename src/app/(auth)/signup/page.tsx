      ...
      <div className="hidden lg:flex lg:w-1/2 bg-foreground text-background flex-col justify-between p-8 lg:p-12">
        ...
        <div className="space-y-6 lg:space-y-8">
          <div className="space-y-3 lg:space-y-4">
            <h2 className="text-2xl lg:text-3xl font-bold leading-tight">Start resizing labels in minutes</h2>
            <p className="text-base lg:text-lg text-background/70">
          ...
          <ul className="space-y-3 lg:space-y-4">
            {features.map((feature) => (
              <li key={feature} className="flex items-center gap-3">
                ...
                <span className="text-sm lg:text-base text-background/80">{feature}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-8">
        <div className="w-full max-w-md lg:max-w-xl space-y-6 lg:space-y-8">
          ...
          <div className="space-y-2 text-center lg:text-left">
            <h1 className="text-2xl lg:text-3xl font-bold tracking-tight text-foreground">Create an account</h1>
            <p className="text-sm lg:text-base text-muted-foreground">Get started with your free account today</p>
          </div>
