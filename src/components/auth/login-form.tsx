  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
      ...
      <div className="space-y-2">
        <label className="block text-sm font-medium text-foreground mb-2 lg:mb-3">
          Login Type
        </label>
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className={`px-3 py-2 lg:px-4 lg:py-2 rounded-lg text-sm font-medium transition-colors ${
      ...
      {/* Submit Button */}
      <Button type="submit" className="w-full h-10 lg:h-11" disabled={isLoading}>
        {isLoading ? (
          <>
