...
// Import additional label definitions
import { averyLabels, shippingLabels, complianceLabels } from './avery-shipping-labels'
...
const amazonFBALabels: Label[] = [
  ...
  {
    id: "amazon_fba_006",
    name: "Amazon FBA 2x1 Thermal (203 DPI)",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 50.8,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    supported_printers: ["zebra_lp2844", "dymo_labelwriter_450"],
    notes: "Compact FNSKU label for small products",
  },
  {
    id: "amazon_fba_007",
    name: "Amazon FBA 2x1 Inkjet",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "inkjet",
    width_mm: 50.8,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Sheet-fed printer compatible",
  },
  {
    id: "amazon_fba_008",
    ...
    product_reference: "FNSKU",
    supported_printers: ["zebra_lp2844", "dymo_labelwriter_450"],
    notes: "Standard Avery 5160 size for Amazon FBA",
  },
  {
    id: "amazon_fba_009",
    name: "Amazon FBA 2.625x1 Inkjet",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "inkjet",
    width_mm: 66.675,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Compatible with Avery 5160/8160 sheets",
  },
  {
    id: "amazon_fba_010",
    name: "Amazon FBA 3.5x1 Thermal",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 88.9,
    ...
    width_px_203dpi: 711,
    height_px_203dpi: 203,
    width_px_300dpi: 1050,
    height_px_300dpi: 300,
    barcode_format: "code128",
    product_reference: "FNSKU",
    supported_printers: ["zebra_lp2844", "dymo_4xl"],
    notes: "Extended FNSKU label with more space",
  },
  {
    id: "amazon_fba_011",
    name: "Amazon FBA 3.5x1 Inkjet",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "inkjet",
    width_mm: 88.9,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Compatible with Avery 5971 sheets",
  },
  {
    id: "amazon_fba_012",
    name: "Amazon FBA 2x3 Thermal",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 50.8,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Vertical orientation FNSKU label",
  },
  {
    id: "amazon_fba_013",
    name: "Amazon FBA 2.25x1.25 Thermal",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 57.15,
    ...
    height_inch: 1.25,
    width_px_203dpi: 457,
    height_px_203dpi: 254,
    width_px_300dpi: 675,
    height_px_300dpi: 375,
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Square-ish FNSKU label format",
  },
  {
    id: "amazon_fba_014",
    name: "Amazon FBA 1x4 Thermal",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 25.4,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    supported_printers: ["dymo_labelwriter_450"],
    notes: "Narrow vertical FNSKU label",
  },
  {
    id: "amazon_fba_015",
    name: "Amazon FBA 1x4 Inkjet",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "inkjet",
    width_mm: 25.4,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Compatible with Avery 5161/8161 sheets",
  },
  {
    id: "amazon_fba_016",
    name: "Amazon FBA 2x4 Thermal",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 50.8,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Medium vertical FNSKU label",
  },
  {
    id: "amazon_fba_017",
    name: "Amazon FBA 2x4 Inkjet",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "inkjet",
    width_mm: 50.8,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Compatible with Avery 5163/8163 sheets",
  },
  {
    id: "amazon_fba_018",
    name: "Amazon FBA 3.33x4 Thermal",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 84.58,
    ...
    width_px_203dpi: 676,
    height_px_203dpi: 812,
    width_px_300dpi: 1000,
    height_px_300dpi: 1200,
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Large FNSKU label format",
  },
  {
    id: "amazon_fba_019",
    name: "Amazon FBA 3.33x4 Inkjet",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "inkjet",
    width_mm: 84.58,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Compatible with Avery 5164/8164 sheets",
  },
  {
    id: "amazon_fba_020",
    name: "Amazon FBA 4x2 Thermal",
    category: "amazon_fba",
    marketplace: "Amazon",
    print_method: "thermal",
    width_mm: 101.6,
    ...
    barcode_format: "code128",
    product_reference: "FNSKU",
    notes: "Horizontal FNSKU label - landscape orientation",
  },
];
...
/**
 * Avery Label Templates (20 labels)
 */
...
const labTagLabels: Label[] = [
  ...
  },
  {
    ...
    notes:
      "Thermal-transfer cryogenic label with 0.375 inch circle for tube tops",
  },
  {
    id: "tr_jtta-9",
...
export function getMarketplaces(): string[] {
  return Array.from(
    new Set(
      ALL_LABELS.map((label) => label.marketplace).filter(Boolean) as string[],
    ),
  );
}
